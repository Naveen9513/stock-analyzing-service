...
from app.exception.Exceptions import StockAppException
...
class SymbolRepository:
    ...
    def get_aggregated_data_with_fetch_date(self, symbol: str, year: int):
        ...
        try:
            ...
            raise StockAppException(f"Database read failed for {symbol}: {str(e)}")
    ...
    def save_monthly_data(self, symbol: str, incoming_data: dict):
        ...
        try:
            ...
            raise StockAppException(f"Database write failed for {symbol}: {str(e)}")
